...
async function syncAllProducts(env: Env, offset: number = 0, forceImageRefresh: boolean = false, prefetchedProducts?: WCProduct[], modifiedAfter?: string): Promise<{ synced: number; errors: string[]; hasMore: boolean; nextOffset: number }> {
